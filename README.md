...
```js
import React, { Component } from 'react';
import Button from Title; // Import a component from another file
...
[`src/Footer.jsx`](src/index.js) with a call to `serviceWorkerRegistration.unregister()`.
